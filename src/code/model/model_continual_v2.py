...
class ContinueModel(nn.Module):
    def __init__(self,class_input_dim):
        ...
        self.head_tache1 = classifier(class_input_dim, 5)
        self.head_tache2 = classifier(class_input_dim, 1)
        self.head_tache3 = classifier(class_input_dim, 3)
        self.head_tache4 = classifier(class_input_dim, 4)
    ...
    def forward(self, x, task_idx):
        ...
        if task_idx == 0:
            ...
            output = self.head_tache4(feature)
        return output
